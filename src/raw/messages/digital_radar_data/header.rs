use crate::raw::messages::digital_radar_data::spot_blanking_status::SpotBlankingStatus;
use crate::raw::messages::digital_radar_data::{CompressionIndicator, RadialStatus};
use crate::raw::messages::primitive_aliases::{
