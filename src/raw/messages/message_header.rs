use crate::raw::messages::definitions::RedundantChannel;
use crate::raw::messages::message_type::MessageType;
use crate::raw::messages::primitive_aliases::{Integer1, Integer2, Integer4};
